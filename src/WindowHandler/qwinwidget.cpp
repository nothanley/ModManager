/* Interacts with native windows Window to bridge QT gui */
      ...
      _reenableParent(false)
{
	...
	if (p_Widget->toolBar){   TOOLBARHEIGHT = p_Widget->toolBar->height() * window()->devicePixelRatio(); }
